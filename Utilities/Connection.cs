...
namespace Utilities
{
    public class DBConnect
    {
        ...
        //String SqlConnectString = "server=cis-mssql1.temple.edu;Database=fa23_3342_tuxNNNNN;User id=tuxNNNNN;Password=XXXXXX";
        
        //Home Connection String - used for working from home using SSH Tunneling.
        String SqlConnectString = "server=127.0.0.1,5555;Database=fa23_3342_tul65164;User id=tul65164;Password=eeMo3Aipie";
